...
import log.sleeping.android.arcturuspiotrek.sleepinglog.daos.RecommendationDao;
...
@Database(entities = {User.class, Sleep.class, Recommendation.class}, version = 2, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    public abstract UserDao userDao();
    public abstract SleepDao SleepDao();
    public abstract RecommendationDao RecommenadtionDao();
}
